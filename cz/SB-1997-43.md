...
- 2. Pevnost v tahu menší než 7x 10^6 N/m^2; a
...
f. Pokud některá osa modelu stroje nekontrolovaného položkami 2B001.a. až 2B001.c. nebo 2B20J má uváděnou přesnost Â 5 μm brusek a 6,5 μm u frézek a soustruhů nebo lepší, je výrobce povinen prověřit tuto hodnotu každých osmnáct měsíců.
...
(pro výpočetní prvky („CE“) vykonávající operace s pevnou i pohyblivou řádovou čárkou je TP = max (TPfp, TPxp))
...
Ke kamerám speciálně konstruovaným nebo upraveným pro užití pod vodou viz 8A002.d. a 8A002.e. Poznámka: Přístrojové kamery specifikované v 6A003.a.3. až 6A003.a.5. s modulárními strukturami je nutno vyhodnocovat podle jejich maximální schopnosti, za použití „elektronických sestav“, které jsou k disposici podle specifikací výrobce kamer.
...
„(Dialkylfosforamidoyl)dihalogenidy, kde alkyl je methyl, ethyl propyl nebo isopropyl“ se doplňují slova
...
6A108 V části b. 1. se za slova „kódový translátor“
...
d. Schheringovy systémy pro měření změn hustoty při explozi.“.
...
- 17. Chinuklidin-3-on-hydrochlorid (CAS 1 193-65-3);
...
- 3. Zařízeni pro filtraci vzduchu s tekutým nebo tuhým absorbčním činidlem.
