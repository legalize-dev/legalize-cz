...
- f) zajišťuje a provozuje jednotný systém varování a vyrozumění a systém veřejné výstrahy podle jiného právního předpisu^29), stanoví způsob informování právnických a fyzických osob o charakteru možného ohrožení, připravovaných opatřeních, způsobu a době jejich provedení,
