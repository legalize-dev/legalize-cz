...
- l) šíří reklamu na loterie a jiné podobné hry nepovolené nebo neoznámené podle zvláštního právního předpisu^38),
...
- o) šíří reklamu na loterie a jiné podobné hry nepovolené nebo neoznámené podle zvláštního právního předpisu^38),
...
- b) do 2 000 000 Kč, jde-li o správní delikt podle odstavce 1 písm. b), c), d), e), f), g), h), i), j), k), l), m) nebo q),
