...
- n) v rozporu s § 3a odst. 1 šíří reklamu na elektronické cigarety nebo na náplně do nich, nebo
...
- c) do 2 000 000 Kč, jde-li o přestupek podle odstavce 1 písm. b), c), d), e), f), g), h), i), k), l), n) nebo o), podle odstavce 2 písm. a), b), c) nebo e) nebo podle odstavce 3 písm. a), b), c), d), e) nebo g).
...
- k) zadá reklamu na hazardní hru provozovanou bez základního povolení podle zákona upravujícího hazardní hry, nebo
...
- j) zpracuje reklamu na hazardní hru provozovanou bez základního povolení podle zákona upravujícího hazardní hry, nebo
