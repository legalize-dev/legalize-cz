...
(2) Údaji o pověření jiného výkonem jednotlivé činnosti, kterou zahrnuje administrace fondu kolektivního investování^8), jsou
...
(3) Pro způsob prezentování sloupcového diagramu, doplňující upozornění a případné použití simulovaných hodnot historické výkonnosti se použijí obdobně články 15 až 19 a příloha č. 3 nařízení Komise^10).
