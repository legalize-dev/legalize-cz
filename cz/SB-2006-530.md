...
- a) informační koncepce podle § 5a odst. 1 zákona a zápis o vyhodnocení podle zvláštního právního předpisu^1),

- b) provozní dokumentace podle § 5a odst. 2 zákona v rozsahu stanoveném zvláštním právním předpisem^1).
...
- a) úplnost informační koncepce; atestační středisko posuzuje, zda informační koncepce má stanovený obsah^1),

- b) úplnost provozní dokumentace; atestační středisko posuzuje, zda provozní dokumentace má stanovený obsah^1),
...
- f) přijímání opatření k odstranění nedostatků zjištěných při vyhodnocování dodržování informační koncepce^1).
