...
Pro účely této tabulky:

— se zkratkou „PZLÚ“ rozumějí dietní potraviny pro zvláštní lékařské účely,

— se výrazem „Všechny PZV“ rozumějí potraviny pro zvláštní výživu, včetně PZLÚ, avšak s výjimkou počáteční a pokračovací kojenecké výživy a obilných a ostatních příkrmů určených pro výživu kojenců a malých dětí.
...
| — D-α-tokoferol | x |  |
| — DL-α-tokoferol | x |  |
| — D-α-tokoferyl-acetát | x |  |
| — DL-α-tokoferyl-acetát | x |  |
| — D-α-tokoferyl-hydrogen-sukcinát | x |  |
| VITAMIN K |  |  |
| — fyllochinon (fytomenadion) | x |  |
| VITAMIN B1 |  |  |
| — thiamin-hydrochlorid | x |  |
| — thiamin-mononitrát | x |  |
| VITAMIN B2 |  |  |
| — riboflavin | x |  |
| — riboflavin-5'-fosfát, sodná sůl | x |  |
| NIACIN |  |  |
| — nikotinová kyselina | x |  |
| — nikotinamid | x |  |
| PANTOTHENOVÁ KYSELINA |  |  |
| — D-pantothenát draselný | x |  |
| — D-pantothenát sodný | x |  |
| — dexpanthenol | x |  |
| VITAMIN B6 |  |  |
| — pyridoxin-hydrochlorid | x |  |
| — pyridoxin-5'-fosfát | x |  |
| — pyridoxin-dipalmitát | x |  |
| LISTOVÁ KYSELINA |  |  |
| — pteroylmonoglutamová kyselina | x |  |
| VITAMIN B12 |  |  |
| — kyanokobalamin | x |  |
| — hydroxokobalamin | x |  |
| BIOTIN |  |  |
| — D-biotin | x |  |
| VITAMIN C |  |  |
| — L-askorbová kyselina | x |  |
| — L-askorbát sodný | x |  |
| — L-askorbát vápenatý | x |  |
| — L-askorbát draselný | x |  |
| — L-askorbyl-6-palmitát | x |  |
| Kategorie 2. Minerály |  |  |
| VÁPNÍK |  |  |
| — uhličitan | x |  |
| — chlorid | x |  |
| — soli citronové kyseliny | x |  |
| — glukonát | x |  |
| — glycerofosfát | x |  |
| — mléčnan | x |  |
| — fosforečnany | x |  |
...
| — citrát železnatý | x |  |
| — ferrum-amonium-citrát | x |  |
| — glukonát železnatý | x |  |
| — fumarát železa | x |  |
...
| — ferrum-sacharát | x |  |
| — elementární železo (karbonyl + elektrolyticky + vodíkem redukované) | x |  |
| MĚĎ |  |  |
| — uhličitan měďnatý | x |  |
| — citrát měďnatý | x |  |
| — glukonát měďnatý | x |  |
| — síran měďnatý | x |  |
| — komplex mědi s lysinem | x |  |
| JOD |  |  |
| — jodid draselný | x |  |
| — jodičnan draselný | x |  |
| — jodid sodný | x |  |
...
| — L-alanin | x |  |
| — L-arginin | x |  |
| — L-arginin-L-aspartát |  | x |
| — L-aspartová kyselina |  | x |
| — L-citrullin |  | x |
| — L-cystein | x |  |
| — L-cystein-N-acetát |  | x |
| — cystin | x |  |
| — L-histidin | x |  |
| — L-glutamová kyselina | x |  |
| — L-glutamin | x |  |
| — glycin | x |  |
| — L-isoleucin |  | x |
| — L-leucin | x |  |
| — L-lysin | x |  |
| — L-lysin-acetát | x |  |
| — L-lysin-L-aspartát |  | x |
| — L-lysin-L-glutamát |  | x |
| — L-methionin | x |  |
| — L-methionin-N-acetát |  | x*) |
| — L-ornithin | x |  |
| — L-fenylalanin | x |  |
| — L-prolin |  | x |
| — L-serin |  | x |
...
| — L-karnitin | x |  |
| — L-karnitin-hydrochlorid | x |  |
| — L-karnitin-L-tartrát | x |  |
| — taurin | x |  |
| Kategorie 5. Nukleotidy |  |  |
| — adenosin-5'-fosforečná kyselina (AMP) | x |  |
| — sodné soli AMP | x |  |
| — cytidin-5'-monofosforečná kyselina (CMP) | x |  |
| — sodné soli CMP | x |  |
| — guanosin-5'-fosforečná kyselina (GMP) | x |  |
| — sodné soli GMP | x |  |
| — inosin-5-fosforečná kyselina (IMP) | x |  |
| — sodné soli IMP | x |  |
| — uridin-5-fosforečná kyselina (UMP) | x |  |
| — sodné soli UMP | x |  |
...
*) Pouze ve výrobcích určené pro osoby starší 1 roku.
...
^1) Směrnice Rady 89/398/EHS o sbližování právních předpisů členských států týkajících se potravin určených pro zvláštní výživu, ve znění směrnice 96/84/EA a směrnice 99/41/ES. Směrnice 2001/15/ES o látkách, které mohou být pro zvláštní výživové účely přidávány do potravin pro zvláštní výživu, ve znění směrnice 2004/5/ES. Směrnice Evropského parlamentu a Rady 2001/13/ES o sbližování právních předpisů členských států týkajících se označování potravin, jejich nabízení k prodeji a související reklamy. Směrnice Komise 91/321/EHS o počáteční a pokračovací kojenecké výživě, ve znění směrnice 96/4/ES, směrnice 1999/50/ES a směrnice 2003/14/ES. Směrnice 1996/5/ES o obilných a ostatních příkrmech pro kojence a malé děti, ve znění směrnice 98/36/ES, směrnice 99/39/ES a směrnice 2003/13/ES. Směrnice Rady 92/52/EHS o počáteční a pokračovací kojenecké výživě určené pro vývoz do třetích zemí. Směrnice 96/8/ES o potravinách pro nízkoenergetickou výživu ke snižování hmotnosti. Směrnice 1999/21/ES o dietních potravinách pro zvláštní lékařské účely.
