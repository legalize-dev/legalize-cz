...
(2) Vláda zvýší nařízením příplatek k důchodu ke zmírnění některých křivd způsobených komunistickým režimem v oblasti sociální^1), a to stejným způsobem a ve stejných termínech, jako se zvyšuje procentní výměra důchodů podle zákona upravujícího důchodové pojištění.
