...
- h) evidence ovocných sadů a evidence využití půdy podle uživatelských vztahů^4a).
...
(1) Ústav je oprávněn požadovat za provedení odborných a zkušebních úkonů podle zvláštních zákonů^4)^,20) náhradu vynaložených nákladů, které je povinen podle těchto zvláštních zákonů hradit žadatel. Výše náhrad nákladů vychází z propočtu nákladů spojených s odbornými a zkušebními úkony.
