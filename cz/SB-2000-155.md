...
Věta první se nepoužije, jsou-li nároky vyplývající z českých právních předpisů pro něho výhodnější. Výhodnost se posuzuje u každého pracovněprávního nároku samostatně.
...
- 8. Za § 18 se vkládá nový § 18a, který zní:
