...
- 1.4 Pokud typ splňuje ustanovení a požadavky tohoto nařízení, autorizovaná osoba vystaví výrobci nebo dovozci spotřebičů, které mají původ v České republice nebo v členských státech Evropského společenství certifikát ES přezkoušení typu a u ostatních spotřebičů certifikát typu. Certifikát ES přezkoušení typu nebo certifikát typu musí obsahovat výsledky zkoušek, popřípadě podmínky jeho platnosti, jakož i nezbytné údaje pro identifikaci certifikovaného typu a v případě potřeby i popis jeho funkce. K certifikátu ES přezkoušení typu nebo certifikátu typu musí být připojeny příslušné technické podklady jako např. výkresy a diagramy.
...
- 6.2 Autorizovaná osoba posoudí spotřebič a podrobí je s přihlédnutím k technické dokumentaci potřebným zkouškám, aby zjistila jejich shodu se základními požadavky. Autorizovaná osoba připojí nebo dá připojit na schválený spotřebič své identifikační číslo a na základě provedených zkoušek vydá písemný certifikát o shodě.
