...
(1) Zařízení staveniště [§ 2 odst. 1 písm. a) bod 2] se kryje provozním úvěrem podle zvláštních předpisů^4) a splátkami odběratelů (investorů).^8)

(2) Nevyfakturované práce a dodávky [§ 2 odst. 1 písm. a) bod 3] včetně nedokončeného zařízení staveniště se kryjí provozním úvěrem podle zvláštních předpisů^4) a splátkami odběratelů (investorů).^8)
...
(2) Doba obratu zásob ve dnech se vyjadřuje zlomkem, v jehož čitateli je stav zásob ke konci roku, násobený 360, a ve jmenovateli výkony.
...
- b) zásoby obchodních, zásobovacích a odbytových organizací,
...
(3) Překračuje-li organizace vytvářející fond rozvoje a obratový fond, u níž se usměrňuje vývoj zásob podle § 7, ve všech čtvrtletích kalendářního roku plánovanou výši doby obratu zásob ve dnech, při současném překračování plánované výše zásob, musí převést na žádost úvěrující pobočky Státní banky československé nejpozději do 31. března následujícího roku z fondu rozvoje do obratového fondu částku odpovídající překročení plánované výše zásob k 31. prosinci příslušného kalendářního roku, přepočtenou podílem obratového fondu na zásobách plánovaného pro tento rok.
...
(2) Sníží-li organizace vytvářející fond rozvoje a obratový fond, u níž se usměrňuje vývoj zásob podle § 7, ve všech čtvrtletích kalendářního roku proti skutečnosti předchozího roku mimo plán dobu obratu zásob ve dnech, při současném snížení plánované výše zásob, může převést se souhlasem úvěrující pobočky Státní banky československé nejpozději do 31. března následujícího roku do fondu rozvoje z obratového fondu částku odpovídající snížení plánované výše zásob k 31. prosinci příslušného kalendářního roku, přepočtenou podílem obratového fondu na zásobách plánovaného pro tento rok.
