...
- b) složka Integrovaného záchranného systému^12) pro vozidlo s právem přednosti jízdy^13) nevyužívané k podnikání a zařazené do okresního požárního poplachového plánu^14) (dále jen „vozidlo složky Integrovaného záchranného systému“).
