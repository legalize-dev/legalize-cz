...
- d) minimální limit pojistného plnění z pojištění znalecké kanceláře a znaleckého ústavu pro jednotlivé obory a odvětví,
...
- d) identifikační číslo osoby, pokud jej žadatel má, nebo jiný obdobný údaj v případě právnické osoby, která identifikační číslo osoby nemá,
...
- g) údaj, zda žadatel, který je fyzickou osobou, bude vykonávat znaleckou činnost v rámci znalecké kanceláře,

- h) telefonní kontakt,

- i) adresu elektronické pošty, adresu internetové stránky týkající se znalecké činnosti, nebo kontaktní adresu, pokud žadatel žádá o zápis této adresy do seznamu znalců jako veřejného údaje podle § 16 odst. 2 zákona,

- j) jinou adresu pro doručování sdělenou žadatelem nebo údaj, že jinou adresou pro doručování je adresa elektronické pošty podle písmene i), pokud žadatel žádá o doručování na jinou adresu pro doručování,

- k) pokud žadatel žádá o umožnění vykonání vstupní zkoušky nebo rozdílové zkoušky, údaj o této skutečnosti,

- l) pokud žadatel žádá o umožnění vykonání vstupní zkoušky, údaj, zda žadatel žádá o umožnění vykonání obou částí vstupní zkoušky nebo pouze jedné její části a které,

- m) zadání zkušebního znaleckého posudku, pokud se obecná část vstupní zkoušky považuje za splněnou, a
...
(2) Formulář žádosti o zápis znaleckého ústavu do seznamu znalců obsahuje též označení osob podle § 7 odst. 1 písm. c) zákona nebo osob, jejichž prostřednictvím je znalecký ústav podle § 7 odst. 2 zákona oprávněn jednat.

(3) Znalci a další osoby, prostřednictvím kterých bude znalecká kancelář nebo znalecký ústav vykonávat znaleckou činnost, se v žádosti označí údaji podle § 2 odst. 1 písm. a) až f).
...
Žadatel doručí ministerstvu požadovaný počet vyhotovení zkušebního znaleckého posudku do 60 dnů od doručení oznámení o výsledku posouzení žadatelem předloženého zadání zkušebního znaleckého posudku.
...
(2) Pokud se zvláštní část vstupní zkoušky skládá z více ústních pohovorů, uveřejnění výsledku zvláštní části vstupní zkoušky a vstupní zkoušky se týká jednotlivých ústních pohovorů.

(3) Ministerstvo při uveřejnění rozliší žadatele označením, které mu přidělilo.
...
(1) Znalecká pečeť se vyhotovuje jako razítko kulatého tvaru o průměru 36 mm, malý státní znak je vyobrazen uprostřed kruhu, na jehož obvodu (v kruhopisu) je jméno, případně jména, a příjmení znalce nebo název znalecké kanceláře nebo znaleckého ústavu, označení „znalec“, „znalecká kancelář“ nebo „znalecký ústav“ a rozsah znaleckého oprávnění, které lze podle okolností uvést ve zkrácené podobě; obor se uvede vždy.
...
(1) Minimální limit pojistného plnění pro znaleckou kancelář a pro znalecký ústav činí 5 000 000 Kč.

(2) Minimální limit pojistného plnění je shodný pro všechny obory a odvětví.
...
- c) označení osoby, která je povinna na žádost orgánu veřejné moci osobně stvrdit nebo doplnit znalecký posudek nebo blíže vysvětlit jeho obsah, pokud znalecký posudek zpracovala znalecká kancelář nebo znalecký ústav,
...
(2) Znalec sebere nebo vytvoří pouze data, která bude analyzovat a která jsou reprezentativní a ve vztahu k zadané odborné otázce srovnatelná nebo z jiných důvodů vhodná. Je-li zdrojem dat písemnost obsažená ve spisu vedeném orgánem veřejné moci, znalec z písemnosti rovněž sebere pouze data, která bude analyzovat a která jsou potřebná k odpovědi na zadanou odbornou otázku.
...
Znalec provede analýzu dat takovým způsobem, aby bylo možné výsledky analýzy dat interpretovat.
...
(2) Znalec zohlední při kontrole svého postupu podle § 52 písm. a) až e) též veškeré skutečnosti, které vzhledem k použitým podkladům a metodám mohou snižovat přesnost závěru znaleckého posudku.

##### § 58

(1) Znalec zformuluje na základě interpretace výsledků analýzy dat závěr znaleckého posudku tak, aby byl jednoznačnou odpovědí výhradně na zadanou odbornou otázku.
...
| Údaj o přiznaném znalečném | Výše – přiznané odměny celkem, bez částky odpovídající dani z přidané hodnoty, s rozlišením části odměny, která je časovou odměnou, a části odměny, která je paušální odměnou, – přiznaných náhrad celkem, bez částky odpovídající dani z přidané hodnoty, a – přiznané celkové částky odpovídající dani z přidané hodnoty, o kterou se zvyšuje znalečné, pokud se znalečné o tuto částku zvyšuje. Též počet přiznaných hodin práce vynaložených na výkon znalecké činnosti, pokud je přiznána časová odměna. Též údaj, zda je odměna smluvní nebo určená, a údaj, zda bylo sjednáno právo na náhrady odchylně od zákona. Též den, měsíc a rok úhrady znalečného. |
