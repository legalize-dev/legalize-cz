...
- d) seznam technických předpisů (§ 3 zákona) a technických norem podle § 2 odst. 3, popřípadě českých technických norem použitých při posouzení shody,

- e) pokud se na posuzování shody podílí autorizovaná osoba [podle § 3 odst. 1 písm. b) a c)] nebo osoba akreditovaná podle § 14 zákona, údaje o této osobě (jméno nebo obchodní jméno, sídlo, identifikační číslo autorizované osoby) a číslo a datum jejího nálezu o strojním zařízení (vzorku),
...
(3) Prohlášení o stroji nebo jeho části (§ 3a) vypracované v českém jazyce obsahuje
...
- f) datum a místo vydání prohlášení, jméno a funkce odpovědné osoby výrobce nebo dovozce a její podpis.
