...
| emulgované studené omáčky, majonézy s obsahem tuku nejméně60% | 1000 | - | - | - | - | - |
...
|  | (i) Sorbitol | deserty na bázi mléka a mléčných přípravků se sníženým obsahem využitelné energie nebo bez přidaného cukru | NM |
|  | (ii) Sorbitol sirup | deserty na bázi ovoce a zeleniny se sníženým obsahem využitelné energie nebo bez přidaného cukru | NM |
| E 421 | Mannitol | deserty na bázi vajec se sníženým obsahem využitelné energie nebo bez přidaného cukru | NM |
| E 953 | Isomalt | deserty na bázi obilovin se sníženým obsahem využitelné energie nebo bez přidaného cukru | NM |
| E 965 | Maltitol | deserty na bázi tuku se snížením obsahem využitelné energie nebo bez přidaného cukru | NM |
|  | (i)Maltitol | obilné snídaně a podobné výrobky na bázi obilovin se sníženým obsahem využitelné energie nebo bez přidaného cukru | NM |
|  | (ii)Maltitol sirup | zmrzliny, mražené krémy a obdobné zmrazené výrobky se sníženým obsahem využitelné energie nebo bez přidaného cukru | NM |
| E 966 | Laktitol | ovocné pomazánky se sníženým obsahem využitelné energie nebo bez přidaného cukru | NM |
| E 967 | Xylitol | ovocné přípravky se sníženým obsahem cukru kromě těch, které jsou určeny pro výrobu nealkoholických nápojů na bázi ovocné šťávy | NM |
...
| potraviny s upraveným obsahem nutričních faktorů s omezenou denní dávkou6a) | 2000 |  |  |
...
| potraviny s upraveným obsahem nutričních faktorů s omezenou denní dávkou6a) | 5500 |  |  |
...
| potraviny s upraveným obsahem nutričních faktorů s omezenou denní dávkou6a) | 1200 |  |  |
...
| dietní potraviny pro kontrolu hmotnosti určené k náhradě celodenní stravy či jednotlivých pokrmů | 100 |  |  |
| stolní sladidla | NM |  |  |
...
| řepka |  |  |
| slunečnice sója |  |  |
| aldicarb suma aldicarbu, jeho sulfoxidu a sulfonu cibule vyjádřená jako aldicarb | 0,05 * | arašídy |
| 0,1 | káva zelená |  |
| 0,2 | citrusy |  |
| 0,5 | banány |  |
| aldimorf | 0,1 | ječmen |
...
| benomyl viz carbendazim | 0,01 | pšenice |
| bensultap | 0,05 | brambory |
...
| 0,01 | obilniny |  |
| fluazifop-P-butyl fluazifop včetně izomérů, esterů a jejich cukrovka konjugátů, vyjádřeno jako fluazifop | 0,1 | cibule |
| česnek |  |  |
| chmel |  |  |
| slunečnice |  |  |
| 0,5 | brambory |  |
...
| měď sloučeniny mědi, vyjádřeno jako měď brukvovitá zelenina | 10 | brambory |
| celer |  |  |
| cibule |  |  |
| hrozny na víno |  |  |
| okurky |  |  |
...
| luštěniny |  |  |
| 15 | obilniny |  |
| permethrin | 0,1 | balené poživatiny |
| suma izomérů | 2 | pšenice |
...
- a) veterinárními léčivy všechny léčivé látky, směsi léčivých látek nebo léčivé přípravky, které jsou podávány zvířatům k léčení, mírnění, prevenci nebo určení diagnózy chorob, s výjimkou látek podávaných zvířatům k vyvolání aktivní nebo pasivní imunity nebo k diagnóze stavu imunity,
...
| 17- estradiol (pro terapeutické a zootechnička použití) | všechny druhy zvířat |
...
| Rifaximin (pouze intramamárně a intrauterinné) | skot |
| Tau fluvalinat | čela |
...
| Somatosalm | pstruh |
| Alfaprostol | kůň |
| Cefazolin (pouze intramamárné) | skot |
