...
(2) Do součtu jmenovatele koeficientu se nezapočítává cena bez daně při převodu cenných papírů, který je osvobozen od daně podle § 28 odst. 2 písm. b), cena bez daně při prodeji podniku nebo jeho části, který je osvobozen od daně podle § 35, cena bez daně za převod staveb, části staveb, bytů a nebytových prostor, který je osvobozen od daně podle § 30, cena bez daně při prodeji platných poštovních cenin a kolkových známek, který je osvobozen od daně podle § 26 písm. e), a příjem provozovatelů loterií a jiných podobných her, který je osvobozen podle § 34. Do součtu jmenovatele koeficientu se nezapočítávají příjmy nebo výnosy za plnění, která nejsou zdanitelná.
