...
(8) Příplatek není součástí důchodu. Výplata příplatku nenáleží po dobu, po kterou nenáleží výplata důchodu uvedeného v § 1, jehož pobírání je podmínkou nároku na příplatek. Příplatek se vyplácí spolu s důchodem stejným způsobem a ve stejných termínech jako důchod. Vláda zvýší nařízením příplatek stejným způsobem a ve stejných termínech, jako se zvyšuje procentní výměra důchodů podle zákona upravujícího důchodové pojištění^2).
