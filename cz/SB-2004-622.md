...
(7) Příplatek se vyplácí měsíčně spolu s důchodem stejným způsobem a ve stejných termínech jako důchod. Příplatek se zvyšuje ve stejných termínech jako důchody podle zvláštního právního předpisu^2).
