...
- b) po osobách uvedených v písmenu a) pobírají vdovský nebo vdovecký důchod z českého důchodového pojištění^1),
...
(2) Příplatek k vdovskému nebo vdoveckému důchodu se stanoví polovinou částky uvedené v odstavci 1.
...
(5) Příplatek se vyplácí měsíčně spolu s důchodem stejným způsobem a ve stejných termínech jako důchod. Příplatek se zvyšuje ve stejných termínech jako důchody podle zvláštního právního předpisu^2).
