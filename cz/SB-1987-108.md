...
- d) Ústav pro státní kontrolu veterinárních biopreparátů a léčiv (dále jen „ústav“), jehož postavení a působnost upravuje zvláštní zákon.^13a)
...
- a) vykonává veterinární dozor podle zákona o veterinární péči^6) a zvláštních zákonů,^1a) vydává závazné pokyny k odstranění zjištěných nedostatků a jejich příčin a kontroluje jejich plnění,
...
- c) vykonává veterinární dozor podle zákona o veterinární péči^6) a zvláštních předpisů,^1a) vydává v případech, v kterých si to vyhradí, závazné pokyny k odstranění zjištěných nedostatků a jejich příčin a kontroluje jejich plnění,
