...
- e) požadavky na prostorové zabezpečení výuky podle akreditovaného nebo autorizovaného vzdělávacího programu,

- f) požadavky na materiální zabezpečení výuky podle akreditovaného nebo autorizovaného vzdělávacího programu,
...
#### ŽÁDOST O AKREDITACI VZDĚLÁVACÍHO PROGRAMU A AUTORIZACE VZDĚLÁVACÍHO PROGRAMU
...
- c) doklady o odborném zabezpečení výuky vzdělávacího programu.

##### § 11

#### Identifikační údaje

Identifikačními údaji podle § 10 písm. a) jsou:
...
- b) údaje o stávajícím vybavení výpočetní technikou a o možnostech jejího využití k uskutečňování vzdělávacího programu,
...
(1) Nejvyšší možná úplata za vyšší odborné vzdělávání (dále jen „školné“) v jednotlivých oborech vzdělání a z nich vycházejících autorizovaných vzdělávacích programů vyšších odborných škol zřizovaných státem, krajem, svazkem obcí nebo obcí se za školní rok stanovuje takto:
