...
#### OVĚŘOVÁNÍ STŘELNÝCH ZBRANÍ, STŘELIVA A PYROTECHNICKÝCH VÝROBKŮ A ZACHÁZENÍ S NĚKTERÝMI PYROTECHNICKÝMI VÝROBKY
...
(1) Tento zákon zapracovává příslušné předpisy Evropských společenství a v návaznosti na přímo použitelný předpis Evropských společenství^1) upravuje
...
(4) Druhy střeliva a jeho částí, které podléhají ověřování^4c), (dále jen „stanovené střelivo“) jsou
...
(5) Za pyrotechnické výrobky se považují výrobky obsahující výbušné látky nebo směs výbušných látek, kterými nejsou trhaviny nebo vojenské výbušniny s výjimkou černého prachu nebo zábleskové slože, určených k produkci tepla, světla, zvuku, plynu, kouře nebo kombinace těchto efektů pomocí samoudržujících se exotermických chemických reakcí. Pyrotechnické výrobky se člení na
...
(6) Osobou s odbornou způsobilostí podle tohoto zákona je fyzická osoba starší 18 let, která je držitelem osvědčení o odborné způsobilosti k zacházení s pyrotechnickými výrobky podle tohoto zákona pro kategorii 4, T2 a P2.
...
- f) označit každý pyrotechnický výrobek dobou použitelnosti a po provedení posouzení shody opatřit označením CE a dalším označením, které stanoví vláda nařízením.
...
(3) Úřad je povinen informovat včas a vhodným způsobem osoby, které mohou být vystaveny vážnému riziku vyvolanému kontrolovaným výrobkem nebo pyrotechnickým výrobkem, o tomto riziku.
...
(5) Výrobce se dopustí správního deliktu tím, že neopatří kontrolovaný výrobek údaji podle § 16 odst. 2 písm. a).

(6) Výrobce nebo dovozce pyrotechnických výrobků uváděných na trh se dopustí správního deliktu tím, že nesplní některou z povinností podle § 16a odst. 1 nebo 2.

(7) Distributor se dopustí správního deliktu tím, že v rozporu s § 16 odst. 3 uvede na trh kontrolovaný výrobek, který není označený zkušební značkou.

(8) Distributor pyrotechnických výrobků se dopustí správního deliktu tím, že v rozporu s § 16a odst. 3 dodá nebo jinak zpřístupní pyrotechnický výrobek, který není označen podle tohoto zákona a prováděcích právních předpisů, nebo pyrotechnický výrobek, u kterého byla překročena doba jeho použitelnosti.

(9) Opravce, kterému byla vydána zbrojní licence podle zvláštního právního předpisu, se dopustí správního deliktu tím, že
...
- a) 5 000 000 Kč, jde-li o správní delikt podle odstavce 1 písm. a) až c), odstavce 2 písm. a) až d) a f), odstavce 4, 7 nebo 8,

- b) 1 000 000 Kč, jde-li o správní delikt podle odstavců 3, 5 nebo 6,

- c) 500 000 Kč, jde-li o správní delikt podle odstavce 1 písm. d) až f), odstavce 2 písm. e) nebo odstavce 9.
...
(4) Správní delikty podle tohoto zákona v prvním stupni projednává úřad, s výjimkou správního deliktu podle § 22a odst. 4, který projednává Česká obchodní inspekce.
