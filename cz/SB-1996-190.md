...
- b) záznamem podrobného měření změn, vedle výsledku podle § 66 odst. 9, také obdobné výsledky zeměměřických činností podle dřívějších předpisů, dokumentované u katastrálního úřadu (měřická část geometrického plánu, polní náčrt a s nimi související dokumentace, např. zápisník měřených údajů).
...
Závazné je geometrické určení s menší střední souřadnicovou chybou podle bod 12.15 přílohy.
...
- c) katastrální mapa obnovená digitalizací mapy podle písmene b) (dále jen „digitalizovaná mapa“), charakterizovaná přesností souřadnic podrobných bodů nižší, než je přesnost stanovená v písmenu a) s převažujícím kódem charakteristiky kvality podrobných bodů 5 nebo 8.
...
(2) Změny názvů katastrálních území provedené v katastru se oznamují ve Zpravodaji Českého úřadu zeměměřického a katastrálního.
...
- e) záznamu podrobného měření změn, jde-li o změnu podle § 66 odst. 11,

- f) podkladů pro opravu chyby podle § 46.
...
(2) Katastrální úřad provádí změny podle odstavce 1 písm. a) nahrazením dosavadních údajů novými předanými příslušným orgánem, podle odstavce 1 písm. b) přizpůsobením údajů změnám výměr parcel s výjimkou vzniku digitální mapy jako výsledku pozemkových úprav [§ 58c písm. l)], podle odstavce 1 písm. c) využitím údajů o BPEJ uvedených v geometrickém plánu [§ 69 odst. 1 písm. e)] a podle odstavce 1 písm. d) z úřední povinnosti.
...
- h) dohody o vypořádání společného jmění manželů,^48) je-li předmětem vypořádání nemovitost,
...
- l) dohody o zrušení a vypořádání podílového spoluvlastnictví k nemovitostem,^49)

- m) smlouvy o výstavbě, jejichž součástí je převod spoluvlastnických podílů pozemků.^50)
...
| 5 | zahrada |  | Pozemek |
| a) na němž se trvale a převážně pěstuje zelenina, květiny a jiné za-hradní plodiny, zpravidla pro vlastní potřebu, |  |  |  |
...
| 9 | Vinice |  |  |  |  |
| 10 | Zahrada |  |  |  |  |
| 11 | Trvalý travní porost |  | 20 | Lávka užší než 2 m širší než 2 m |  |
| 13 | Lesní pozemek |  |  |  |  |
