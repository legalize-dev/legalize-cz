...
(1) Rozpisem státního rozpočtu obdrží každý kraj účelově vázanou částku na úhradu prokazatelné ztráty ze závazku provozu a závazku přepravy (dále jen „účelově vázaná částka“). Výše účelově vázané částky se pro jednotlivé příslušné kraje odvozuje z celkové výše prokazatelné ztráty ze závazku provozu a závazku přepravy v České republice podle propočtené účetní ztráty veřejné osobní dopravy v jednotlivých okresech.
...
(3) Příslušný kraj stanoví v návaznosti na účelově vázanou částku a podle rozsahu veřejné drážní osobní dopravy uskutečněné v závazku veřejné služby vyjádřeného ve vlakových kilometrech dotační jednotku v korunách na jeden vlakový kilometr.

(4) Úhradu prokazatelné ztráty ze závazku provozu a ze závazku přepravy danou součinem dotační jednotky a počtu ujetých vlakových kilometrů poskytne příslušný kraj zálohově podle smlouvy o závazku veřejné služby a vyúčtování po předložení výkazu (§ 3 odst. 1) podle skutečně ujetých vlakových kilometrů.

##### § 5

#### Náležitosti smlouvy o závazku veřejné služby

(1) Smlouva o závazku veřejné služby (dále jen „smlouva“)^8) se sjednává mezi Českou republikou zastoupenou ministerstvem nebo příslušným krajem na jedné straně (dále jen „objednatel“) a dopravcem na straně druhé.
