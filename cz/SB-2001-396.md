...
- b) má zřízen peněžní fond,^1) jehož prostředky jsou vedeny na zvláštním účtu v bance a jsou určeny na opravy nebo modernizace bytů, (dále jen „úvěrový fond“),

- c) do úvěrového fondu převádí prostředky z úvěru poskytnutého Fondem a vlastní prostředky určené na opravy nebo modernizace bytů,

- d) vydá pravidla pro použití prostředků úvěrového fondu obsahující alespoň skutečnosti uvedené v § 3,
...
- b) pravidla obsahující podmínky použití prostředků úvěrového fondu podle odstavce 1 písm. d),

- c) název účtu u banky, na kterém budou soustředěny prostředky úvěrového fondu,
