...
K barvení a značkování některých uhlovodíkových paliv a maziv (dále jen „paliva a maziva“) uvedených v § 2 odst. 1 zákona č. 136/1994 Sb. (dále jen „zákon“) se používá tekuté směsi barviva a značkovací látky, jejíž obchodní název zní „Sudan Rotmarker“ a nebo výrobku shodné funkce, který byl certifikován.^1)

##### § 2

#### Provádění barvení a značkování

Paliva a maziva musí být obarvena a označkována tak, aby obsahovala 20 g barvicí a značkovací směsi na 1 t paliva a maziva. Odchylka od této hodnoty může činit nejvýše ± 2 g barvicí a značkovací směsi na 1 t paliva a maziva.
...
(4) Zjistí-li příslušný státní orgán zabarvení paliva a maziva barvou odpovídající barvicí a značkovací směsi podle § 1, oddělí ze vzorku odebraného podle odstavce 2 část pro provedení analýzy autorizovanou státní zkušebnou^2) a část pro kontrolní uložení.

(5) Není-li zjištěno zabarvení paliva a maziva barvou odpovídající barvicí a značkovací směsi podle § 1, provede příslušný státní orgán kontrolu testovací soupravou pro provádění kontrol v terénu, způsobilou identifikovat přítomnost barvicí a značkovací směsi ve vzorku. Kontrola spočívá ve smísení vzorku paliva a maziva s reakčním činidlem. Vykazuje-li po protřepání a odsazení spodní vrstva zabarvení odpovídající barvicí a značkovací směsi podle § 1, popřípadě nedojde-li k odsazení spodní vrstvy, příslušný státní orgán postupuje podle odstavce 4.

(6) Minimální objem odebraného vzorku je 170 cm^3. Pro autorizovanou státní zkušebnu^2) se oddělí v případě postupu podle odstavců 4 a 5 alespoň 70 cm^3 a pro kontrolní uložení alespoň 70 cm^3.

(7) Příslušný státní orgán zajistí, aby nedošlo ke zničení, záměně, upravení nebo zneužití vzorku odebraného pro provedení analýzy autorizovanou státní zkušebnou^2) a vzorku odebraného pro kontrolní uložení. Odebraný vzorek zapečetí, označí a uloží ve vzorkovnici. S vynaložením odborné péče zajistí, aby nedošlo ke zmaření provedení analýzy.
...
- c) označení osoby uvedené v § 3 odst. 1, přizvané k odběru vzorku, číslo občanského průkazu této osoby,
...
- f) výsledek kontroly provedené podle § 3 odst. 4 nebo 5,
...
(4) Je-li vzorek doručován autorizované státní zkušebně,^2) vyhotoví příslušný státní orgán průvodní list požadující provedení analýzy autorizovanou státní zkušebnou,^2) který bude obsahovat identifikační údaje týkající se odebraného vzorku, nikoli však údaje o osobě uvedené v § 3 odst. 1 a o místě a dnu provedení odběru.

##### § 5

(1) Příslušný státní orgán zajistí doručení vzorku autorizované státní zkušebně^2) nejméně dvěma osobami v den odběru vzorku, není-li to možné z důvodu na straně autorizované státní zkušebny,^2) v pracovní den následující po dni odběru vzorku.
...
(3) Výrobci barvicí a značkovací směsi vedou evidenci a provádějí týdenní bilanci o množství, vlastnostech a složení vyrobené barvicí a značkovací směsi a o fyzických osobách, které jsou podnikateli,^3) a o právnických osobách, kterým barvicí a značkovací směs dodávají. Uživatelé barvicí a značkovací směsi vedou evidenci o množství, vlastnostech, složení převzaté barvicí a značkovací směsi, o jejím použití, o fyzických osobách, které jsou podnikateli,^3) a o právnických osobách, které jim barvicí a značkovací směs dodávají.
...
^1) § 24a až 24d zákona č. 30/1968 Sb., o státním zkušebnictví, ve znění zákona č. 54/1987 Sb.
