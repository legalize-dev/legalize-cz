...
- b) větší než 50 bar.l a menší než 3000 bar.l, podrobeny na základě volby výrobce nebo dovozce ověřování shody autorizovanou osobou podle § 5 nebo ověřování shody výrobcem podle § 6.
...
při tloušťce ł 3 mm: A ł 22 %,

při tloušťce Ł 3 mm: A80 mm ł 17 %,

2) jsou-li zkušební vzorky odebírány kolmo ke směru válcování:

při tloušťce ł 3 mm: A ł 20 %,

při tloušťce Ł 3 mm: A80 mm ł 15 %,
...
A ł 16 %, jestliže je zkušební vzorek odebírán ve směru válcování,

A ł 14 %, jestliže je zkušební vzorek odebírán kolmo ke směru válcování.
...
- a) nejnižší pracovní teplotu Tmin,

- b) nejvyšší pracovní teplotu Tmax,
...
- b) nejvyšší pracovní teplotu (Tmax ve °C),

- c) nejnižší pracovní teplotu (Tmin ve °C),
...
A tažnost po přetržení ( LO = 5,65, So ) %
