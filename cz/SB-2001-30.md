...
- n) „Text“ (č. E 12), která omezuje nebo doplňuje platnost značky, pod kterou je umístěna, vhodným nápisem, případně symbolem.
...
[image omitted] [image omitted] [image omitted] [image omitted] [image omitted] [image omitted] [image omitted] [image omitted] [image omitted] [image omitted] [image omitted] [image omitted] [image omitted] [image omitted] [image omitted] [image omitted] [image omitted] [image omitted] [image omitted] [image omitted] [image omitted] [image omitted] [image omitted]
