...
- d) dopustí se závažného jednání, aby zmařil účel ochranného léčení, ústavní nebo ochranné výchovy, které byly uloženy soudem, nebo jinak, zejména útěkem z ústavu, výkon takových rozhodnutí podstatně ztěžuje, nebo
