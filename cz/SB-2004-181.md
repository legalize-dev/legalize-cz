...
(1) Výrobce, jehož výrobky mají být vyváženy formou pravidelně uskutečňovaných vývozů podle předpisů Evropských společenství,^5) požádá Fond o registraci za účelem vývozu těchto výrobků formou pravidelně uskutečňovaných vývozů.
...
- b) seznam všech základních výrobků určených ke zpracování, na něž bude uplatňován nárok na subvenci při vývozu, a
