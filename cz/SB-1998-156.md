...
(5) Na hnojiva ES se použijí ustanovení přímo použitelného předpisu Evropské unie o hnojivech^2) a dále ustanovení tohoto zákona o skladování (§ 8), používání (§ 9), odborném dozoru (§ 12), zvláštních opatřeních (§ 13) a přestupcích (§ 14 až 14b).
