...
- 2. ekologicky významný prvek evidovaný v evidenci ekologicky významných prvků podle zákona upravujícího zemědělství, nebo
...
(2) Základem daně u lesního pozemku je cena pozemku zjištěná podle platných cenových předpisů k 1. lednu zdaňovacího období nebo součin skutečné výměry pozemku v m^2 a částky 3,80 Kč.
