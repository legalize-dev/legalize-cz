...
(2) Za příjem se nepovažuje část sociálního příplatku a příspěvku na úhradu potřeb dítěte^11) náležející ze zdravotních důvodů^11), daňový bonus^12) a zvýšení důchodu pro bezmocnost a zvláštní příspěvek k důchodu podle zvláštních právních předpisů.^9a)
