...
(3) Zemědělský podnikatel^12b) spolu s registračním lístkem předkládá kopii dokladu potvrzujícího skutečnost, že je podnikatelem podle zvláštního právního předpisu,^13) ne starší než 3 měsíce.
...
- e) umístění každého stanoviště včelstev, číselný kód katastrálního území, parcelní číslo, typ parcely, případně adresa, pokud je známá,
