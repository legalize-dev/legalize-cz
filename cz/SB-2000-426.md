...
(6) V případě rádiových zařízení používajících kmitočtová pásma, jejichž použití není v České republice stanoveno Úřadem v generální licenci,^10a) výrobce nebo dovozce oznámí orgánu, který odpovídá za správu kmitočtového spektra,^10) záměr uvést tato zařízení na trh České republiky. Toto oznámení musí být učiněno nejpozději 4 týdny před uvedením zařízení na trh a musí obsahovat informace o radiotechnických charakteristikách zařízení, zejména o kmitočtových pásmech, odstupu kanálů, druhu modulace a vysokofrekvenčním výkonu, a identifikační číslo autorizované osoby.
