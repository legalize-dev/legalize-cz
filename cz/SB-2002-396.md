...
(2) Úvěr je určen na úhradu části nákladů spojených s výstavbou bytu.
...
(3) Za byty v jednom odstraňovaném objektu mohou být poskytnuty nejvýše tři úvěry. Pokud je odstraňovaný objekt ve spoluvlastnictví, rozdělí se celková částka poskytnutých úvěrů mezi spoluvlastníky podle velikosti spoluvlastnických podílů.

(4) Žádá-li osoba uvedená v § 2 odst. 1 a 2 o poskytnutí úvěru za více bytů v odstraňovaném objektu a nemůže doložit příslušnou stavební dokumentací ani jinak, že v odstraňovaném objektu bylo více bytů, má se za to, že v odstraňovaném objektu byl pouze jeden byt.

(5) Úvěr se neposkytne, jestliže obec, na jejímž území se v rozhodný den nacházel odstraňovaný objekt, čerpá státní dotaci z Ministerstva pro místní rozvoj podle „Programu finanční podpory na výstavbu nájemních bytů pro občany postižené povodněmi v roce 2002“.
...
- d) potvrzením příslušného orgánu, že osoba uvedená v § 2 odst. 1 a 2 byla v rozhodný den v odstraňovaném objektu přihlášena k trvalému pobytu.
...
- a) osoba uvedená v § 2 v rozhodný den v odstraňovaném objektu trvale bydlela a byla v něm přihlášena k trvalému pobytu,
...
Osoba uvedená v § 2 může použít prostředky úvěru na výstavbu bytu podle § 4 odst. 2 písm. a), jestliže:
...
(1) Úvěr včetně úroků je splatný nejpozději do 20 let ode dne, kdy bylo započato s jeho čerpáním.
