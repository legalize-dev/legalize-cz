...
(3) Ve věcech důchodového pojištění a dávek podle zvláštních předpisů vyplácených spolu s důchody^1a) je k řízení příslušný krajský soud, v jehož obvodu má navrhovatel bydliště, popřípadě v jehož obvodu se zdržuje.
...
(4) Je-li řízení přerušeno, nekonají se jednání a neběží lhůty podle tohoto zákona.

(5) Po odpadnutí překážky předseda senátu i bez návrhu usnesením vysloví, že se v řízení pokračuje.
