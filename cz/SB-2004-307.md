...
(1) Datové soubory přiřazené k jednotlivým výkazům podle § 4 odst. 1, § 5 odst. 1, § 6 odst. 1, § 6a odst. 1 a § 6b odst. 1 využívá vykazující subjekt pro zjištění metodiky [§ 2 odst. 2 písm. c)] k sestavování výkazů a pro jejich předkládání. Vykazující subjekt podle zjištěné metodiky vytváří z údajů svého informačního systému datový soubor s hodnotami údajů, který předává jako součást datové zprávy^16) České národní bance.
