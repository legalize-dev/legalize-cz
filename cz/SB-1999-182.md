...
- a) kde to přichází v úvahu, může být použita vhodná dokumentace, aby se předešlo opakovanému označování jednotlivých konstrukčních dílů, jako jsou potrubní části, určených pro tutéž sestavu. Týká se to označení CE a dalšího označení a nápisů na štítku podle této přílohy;
