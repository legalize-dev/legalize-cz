...
- c) autorizuje subjekty k výkonům v oblasti státní metrologické kontroly měřidel a úředního měření, pověřuje oprávněné subjekty k uchovávání státních etalonů a kontroluje plnění stanovených povinností u všech těchto subjektů; při zjištění nedostatků v plnění stanovených povinností může autorizaci odebrat;
