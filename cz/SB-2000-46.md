...
(2) Je-li periodický tisk vydáván v regionálních mutacích, vydavatel splní povinnost podle odstavce 1 písm. f) dodáním povinného výtisku takového periodického tisku krajské knihovně příslušné podle označení regionální mutace a dodáním regionálních mutací Státní technické knihovně v Praze.
