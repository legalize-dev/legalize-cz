...
(3) Pokud se harmonizovaná česká technická norma nebo zahraniční technická norma přejímající harmonizovanou evropskou normu v členských státech Evropské unie (§ 4a odst. 3 zákona) týká některého ze základních požadavků, má se za to, že
...
(4) Dodavatelé výtahů poskytují na základě žádosti kopie certifikátů nebo jiných dokumentů, včetně souvisejících dokladů, Úřadu a autorizovaným osobám.
...
(2) V případech vyplývajících z § 13 odst. 8 zákona dovozce předkládá orgánu dozoru doklady v jazyce jednoho z členských států Evropské unie, nebo v jazyce, který s orgánem dozoru dohodne.

##### § 6a

(1) Na bezpečnostní komponenty a výtahy se umísťuje označení CE podle přílohy č. 3 k tomuto nařízení a následně se bez zbytečného odkladu vydává ES prohlášení o shodě podle přílohy č. 2 k tomuto nařízení.
...
- 4. Vyhovuje-li vzorek bezpečnostní komponenty základním požadavkům, vystaví autorizovaná osoba ES certifikát o přezkoušení typu (dále jen „certifikát o přezkoušení typu“), který žadateli předá. Certifikát obsahuje identifikační údaje o výrobci bezpečnostní komponenty, závěry přezkoušení, podmínky platnosti certifikátu a údaje potřebné k identifikaci certifikovaného typu bezpečnostní komponenty.
...
- 1. Závěrečná inspekce je postup, jímž se dodavatel výtahu, splňující ustanovení bodu 2., přesvědčuje a prohlašuje, že výtah, který uvádí na trh, splňuje základní požadavky. Dodavatel výtahu umísťuje v kleci každého výtahu označení CE a vydává prohlášení o shodě podle § 6a odst. 1.
...
- 5. Jestliže výtah vyhovuje ustanovením tohoto nařízení, autorizovaná osoba připojí nebo nechá dodavatele připojit k označení CE své identifikační číslo a vydá certifikát o ověření shody výtahu s certifikovaným typem s uvedením provedených zkoušek a kontrol.
...
Výrobce nebo dovozce bezpečnostní komponenty odpovídající předchozímu ustanovení umístí na každou bezpečnostní komponentu označení CE a vydá prohlášení o shodě podle § 6a odst. 1. Označení CE musí být doplněno identifikačním číslem autorizované osoby provádějící dohled podle bodu 4.
...
Výrobce nebo dovozce bezpečnostní komponenty umístí na každou vyhovující bezpečnostní komponentu označení CE a vydá prohlášení o shodě podle § 6a odst. 1. Označení CE musí být doplněno identifikačním číslem autorizované osoby provádějící dohled podle bodu 4.
...
Výrobce nebo dovozce bezpečnostních komponent vydá prohlášení o shodě podle § 6a odst. 1 a na každou bezpečnostní komponentu umístí označení CE.
...
Dodavatel výtahu umístí na každý výtah označení CE a vydá prohlášení o shodě podle § 6a odst. 1. Označení CE musí být doplněno identifikačním číslem autorizované osoby provádějící dohled podle bodu 4.
...
Dodavatel výtahu vydá prohlášení o shodě podle § 6a odst. 1 a umístí na každý výtah označení CE. Označení CE musí být doplněno identifikačním číslem autorizované osoby provádějící dohled podle bodu 4.
