...
- 1. ES přezkoušení typu je postup, při kterém autorizovaná osoba certifikátem ověřuje a potvrzuje, že vzorek reprezentující uvažovanou produkci splňuje požadavky tohoto nařízení, které se na něj vztahují.

- 2. Žádost o ES přezkoušení typu podává výrobce, jeho zplnomocněný zástupce nebo dovozce u autorizované osoby.

Žádost obsahuje

- název a adresu výrobce, a pokud je žádost podána jeho zplnomocněným zástupcem, také jeho název a adresu, stejně tak název a adresu případného dovozce, pokud podává žádost on,
...
- 5. Pokud typ splňuje odpovídající ustanovení tohoto nařízení, vydá autorizovaná osoba žadateli certifikát ES o typové zkoušce. Certifikát musí obsahovat jméno a adresu výrobce, závěry zkoušky a nezbytné údaje potřebné pro identifikaci schváleného typu.

K certifikátu se přikládá originál seznamu souvisejících částí technické dokumentace, kopie seznamu si ponechá autorizovaná osoba.

Pokud autorizovaná osoba nevydá výrobci, jeho zplnomocněnému zástupci nebo dovozci certifikát ES o typové zkoušce musí pro toto odmítnutí uvést důvody.

- 6. Žadatel informuje autorizovanou osobu, která uchovává technickou dokumentaci týkající se certifikátu ES o typové zkoušce, o všech úpravách schváleného výrobku, pro který musí obdržet dodatečné schválení, pokud tyto změny mohou ovlivnit shodu se základními požadavky nebo předepsané podmínky pro použití výrobku. Toto dodatečné schválení se provádí formou dodatku k původnímu certifikátu ES o typové zkoušce.

- 7. Autorizovaná osoba oznámí ostatním autorizovaným osobám odpovídající informace týkající se certifikátů ES o typové zkoušce a vydaných a zrušených dodatcích.

- 8. Ostatní autorizované osoby mohou obdržet kopie certifikátů ES o typové zkoušce a jejich dodatků. Dodatky k certifikátům musí být kdykoliv k dispozici ostatním autorizovaným osobám.

- 9. Výrobce, jeho zplnomocněný zástupce nebo dovozce uchovávají spolu s technickou dokumentací též kopie certifikátů ES o typové zkoušce a jejich dodatky po dobu nejméně 10 let od výroby posledního kusu výrobku.

Pokud není znám výrobce nebo dovozce, uchovává technickou dokumentaci osoba, která uvádí výrobek na trh.

II. Shoda s typem

- 1. Postup, podle něhož výrobce, jeho zplnomocněný zástupce nebo dovozce zajistí a prohlásí, že daná výbušnina je shodná s typem popsaným v certifikátu ES o typové zkoušce a splňuje odpovídající požadavky tohoto nařízení.

Výrobce ke každému výrobku připojí označení CE a vypracuje pro příslušný typ výbušniny písemné prohlášení o shodě.

- 2. Výrobce přijme všechna nezbytná opatření, aby výrobní postup zajišťoval shodu vyrobených výrobků s typem popsaným v certifikátu ES o typové zkoušce a s odpovídajícími bezpečnostními požadavky tohoto nařízení.
...
- 1. Postup, podle něhož výrobce, který splňuje povinnosti stanovené v bodě 2, zajišťuje a prohlašuje, že dané výbušniny jsou ve shodě s typem popsaným v certifikátu ES o typové zkoušce a splňují požadavky tohoto nařízení.
...
- technickou dokumentaci schváleného typu a kopii certifikátu ES o typové zkoušce.

- 3.2 Systém jakosti musí zaručovat shodu výbušniny s typem popsaným v certifikátu ES o typové zkoušce a s požadavky tohoto nařízení, které se na ně vztahují.
...
Výrobce, jeho zplnomocněný zástupce nebo dovozce informuje autorizovanou osobu, která schválila systém jakosti, o každé zamýšlené úpravě tohoto systému.
...
- 1. Postup, podle něhož výrobce, jeho zplnomocněný zástupce nebo dovozce zajišťuje a osvědčuje, že výbušniny podléhající ustanovením části III. jsou shodné s typem popsaným v certifikátu ES o typové zkoušce a splňují odpovídající požadavky tohoto nařízení.

- 2. Výrobce provede všechna opatření nezbytná k tomu, aby výrobní postup zajišťoval shodu výbušnin s typem popsaným v certifikátu ES o typové zkoušce a s požadavky tohoto nařízení, které pro ně platí. Výrobce ke každé výbušnině připojí označení CE a vypracuje prohlášení o shodě.
...
- 4.1 Všechny výbušniny musí být jednotlivě zkontrolovány a odpovídajícím způsobem přezkoušeny podle požadavků v příslušných normách nebo musí být provedeny ekvivalentní zkoušky pro ověření jejich shody s typem popsaným v certifikátu ES o typové zkoušce a odpovídajícími požadavky tohoto nařízení.
