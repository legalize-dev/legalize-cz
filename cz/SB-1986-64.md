...
- e) zda bylo při uvádění stanovených výrobků na trh vydáno prohlášení o shodě a zda vlastnosti stanovených výrobků uvedených na trh odpovídají stanoveným technickým požadavkům^1a) a zda v souvislosti s označením stanoveného výrobku byly splněny i požadavky stanovené zvláštními právními předpisy,^1c)
