...
(2) Podílový list může být vydán na jméno nebo na doručitele. Podílový list na jméno je převoditelný rubopisem. Podílový list na doručitele se převádí jeho předáním.
