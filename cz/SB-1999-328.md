...
(8) Nelze-li z důvodu nedostatku místa v kontaktním elektronickém čipu zapsat všechny požadované údaje, určí občan, které z nich se zapíší.

(9) Skutečnosti zapsané v občanském průkazu není občan povinen prokazovat jiným způsobem, pokud tak nestanoví zvláštní právní předpis.
...
(6) Žádost lze podat v elektronické podobě na formuláři stanoveném ministerstvem; formulář zveřejňuje ministerstvo způsobem umožňujícím dálkový přístup. Není-li žádost doručena prostřednictvím datové schránky, je třeba ji podepsat uznávaným elektronickým podpisem^4).
