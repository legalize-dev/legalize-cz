...
- m) typy spojovacích systémů, jejich hlavních částí, včetně jejich zapojení, užívání a denní údržby (pouze u skupin vozidel C1+E, C+E, D1+E a D+E),

- n) metody používané k odhalení příčin poruch,

- o) zásady preventivní údržby vozidel a řádných oprav,

- p) odpovědnost řidiče při nakládce a vykládce nákladu (pouze u skupin vozidel C1, C1+E, C a C+E).
