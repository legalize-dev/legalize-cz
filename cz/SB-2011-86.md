...
Toto nařízení zapracovává příslušné předpisy Evropské unie^1) a upravuje technické požadavky na hračky a podmínky pro jejich uvádění na trh.
...
| --- | --- | --- |
| Nikl | CMR 2 | v nerezavějící oceli |
...
- 3.1 Výrobce připojí požadované označení shody uvedené v právním předpisu na každou jednotlivou hračku, která je ve shodě s typem popsaným v certifikátu ES přezkoušení typu a splňuje příslušné požadavky tohoto nařízení.
...
- 8. Každá notifikovaná osoba informuje Úřad o certifikátech ES přezkoušení typu nebo dodatcích k nim, které vydala nebo odejmula, a pravidelně či na žádost zpřístupní Úřadu seznam certifikátů nebo dodatků k nim, které odmítla, pozastavila či jinak omezila.

Každá notifikovaná osoba informuje ostatní notifikované osoby o certifikátech ES přezkoušení typu nebo dodatcích k nim, které odmítla, zrušila, pozastavila či jinak omezila, a na základě žádosti také o certifikátech nebo dodatcích k nim, které vydala.
