...
(1) Provoz na pozemních komunikacích upravují zvláštní předpisy; v jejich mezích smí každý užívat dálnic, silnic a místních komunikací obvyklým způsobem k účelům, ke kterým jsou určeny (obecné užívání). Uživatel se musí přizpůsobit stavebnímu stavu a dopravně technickému stavu dotčené komunikace; nesmí ji poškozovat nebo znečisťovat.
