...
- a) písemné plné moci udělené zástupcům všech účastníků řízení, jsou-li tito v řízení o povolení spojení zastoupeni,
...
- c) listiny zakládající spojení nebo osvědčující jeho vznik, došlo-li k němu na základě jiné právní skutečnosti; v případě spojení v důsledku nabytí účastnických cenných papírů při nabídce převzetí^1) jsou všichni spojující se soutěžitelé povinni tyto listiny předložit ihned po jejich sepsání,
...
- f) schéma a způsob výpočtu obratu, jehož výše odůvodňuje podání návrhu.

##### § 2

(1) Návrh, včetně všech jeho součástí a příloh, se předkládá v českém jazyce. U cizojazyčných listin a dokladů se předkládá jejich překlad do českého jazyka, pokud zvláštní právní předpis nebo mezinárodní smlouva, kterou je Česká republika vázána, nestanoví jinak. K překladu se připojí prohlášení účastníka řízení deklarující, že se jedná o pravdivé a úplné překlady originálů.

(2) Listiny mohou být originály nebo jejich kopie; v případě kopií je nutno k listinám připojit prohlášení účastníka řízení deklarující, že se jedná o pravdivé a úplné kopie originálů.
...
- 1.1.1. obchodní firmu všech účastníků řízení (popř. název, jméno a příjmení),

- 1.1.2. sídlo všech účastníků řízení (popř. trvalý pobyt a místo podnikání, nejedná-li se o soutěžitele majícího sídlo),

- 1.1.3. předmět podnikání všech účastníků řízení (popř. činnosti, za jejímž účelem byli zřízeni, nejde-li o podnikatele),

- 1.1.4. identifikační číslo všech účastníků řízení,

- 1.1.5. údaje o kontaktní osobě, kterou může být statutární orgán nebo jeho člen anebo jiný zástupce účastníka řízení (jméno, adresa, telefonní číslo, faxové číslo, e-mail, funkce příslušné kontaktní osoby).

- 1.2. ZMOCNĚNÍ ZÁSTUPCI

Uveďte údaje o všech zástupcích, kteří byli zmocněni na základě plné moci jednat za jednotlivé účastníky řízení:
...
- a) spojení přeměnou podle § 12 odst. 1 zákona,

- b) spojení nabytím podniku smlouvou o prodeji podniku nebo jeho části podle § 12 odst. 2 zákona,

- c) spojení získáním kontroly (přímé či nepřímé) podle § 12 odst. 3 zákona,

- d) spojení založením nového soutěžitele společně kontrolovaného více soutěžiteli podle § 12 odst. 4 zákona, nebo
...
- 2.1.6. Uveďte jakoukoliv finanční nebo jinou podporu z veřejného zdroje včetně orgánů veřejné správy, obdrženou kterýmkoliv spojujícím se soutěžitelem, a to s členěním na
...
- c) osoby, které kontroluje stejná osoba, jež kontroluje nejméně jednoho ze spojujících se soutěžitelů, a
...
- b) obrat každé z osob, které spojující se soutěžitele kontrolují,

- c) obrat každé z osob, které jsou spojujícími se soutěžiteli kontrolovány,

- d) obrat každé z osob, které kontroluje stejná osoba, jež kontroluje nejméně jednoho ze spojujících se soutěžitelů,
...
- b) na území, které je podle názoru účastníků řízení s ohledem na bod 4.2. odlišitelné od území České republiky,
...
- 7.4. Specifikujte další relevantní údaje o nabídkové straně, jestliže podle názoru účastníků řízení takové existují.
...
- 8.3. Popište světové souvislosti spojení a naznačte postavení všech spojujících se soutěžitelů mimo území České republiky s ohledem na jejich význam a tržní sílu.
...
- 8.5. V případě, že hodláte přijmout omezení ve prospěch zachování účinné hospodářské soutěže, uveďte je a vysvětlete, jak se přijetí takových opatření může projevit na zmírnění negativních dopadů na účinnou hospodářskou soutěž po uskutečnění spojení.
...
(Dotazník musí být podepsán všemi účastníky řízení nebo jejich zmocněnými zástupci.)
